...
public class ReaderWriterLock {
    ...
    //Called by a reader to acquire a read lock.
    ...
    //Called by a reader to release a read lock.
    ...
    //Called by a writer to acquire a write lock.
    public void lockWrite() throws InterruptedException {
        //Writers acquire the write semaphore directly.
        wrt.acquire();
    }

    //Called by a writer to release a write lock.
